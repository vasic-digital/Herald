...
| Status | active |
| Status summary | HRD-012 Claude Code dispatcher live integration closed atomically per §107 (Plan 2 Tasks 6+7 produced 2 independent live PASS runs against real `claude --resume`). HRD-011 Telegram stays open as "code complete; awaiting live E17/E19 evidence" — code committed in 92c9cb3..a254fec + 7697644 but operator credentials (HERALD_TGRAM_BOT_TOKEN + HERALD_TGRAM_CHAT_ID) required to capture E17/E19 live PASS before honest Issues→Fixed migration. Operator guide `docs/guides/OPERATOR_CREDENTIALS.md` added in this revision with step-by-step instructions for all supported messengers + LLM dispatchers + audit checklist. Prior context: HRD-010 closed in r6 (commons_storage live wiring complete; §107 E14/E15/E16 invariants live; production RLS bypass discovered + fixed via TDD). Spec V3 r6 adds §43 Constitution-derived flavor commands. |
| Issues | HRD-008, HRD-011 (code complete; live evidence pending), HRD-015, HRD-016, HRD-018..HRD-028, HRD-029..HRD-056, HRD-081, HRD-085..HRD-090 |
| Issues summary | 50 open / in-progress workable items. HRD-012 was closed atomically in r7 with live PASS evidence; HRD-011 code complete but live-evidence-pending per §107 (no PASS-bluff). |
| Fixed | HRD-001..HRD-007, HRD-009, HRD-009b, HRD-010, HRD-012, HRD-013, HRD-014, HRD-017, HRD-080 |
...
|---|---|---|---|---|---|---|---|
| HRD-011 | task | code complete; awaiting live E17/E19 evidence | middle | Telegram channel adapter live integration — code complete commits 92c9cb3..a254fec + 7697644 (telebot v3.3.8 vendored; HealthCheck + Send + Subscribe + outbound_delivery_evidence persistence all live-wired with §107 bluff guards). §107 BLOCKS Issues→Fixed migration until operator provides HERALD_TGRAM_BOT_TOKEN + HERALD_TGRAM_CHAT_ID and E17 + E19 capture live PASS. See docs/guides/OPERATOR_CREDENTIALS.md. | 2026-05-20 | 2026-05-21 | spec V3 §11.1; Catalogue-Check: no-match → vendor telebot.v3 as submodules/telebot per §11.4.74 |
