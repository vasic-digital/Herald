...
| Status | active |
| Status summary | r9 doc-cleanup: renumbers the Wave 3a commons_auth scaffold from HRD-093 → **HRD-099** to resolve a collision with Wave 2's HRD-093 (sherald flavor scaffold). Catalogue-check evidence relocated to `docs/catalogue-checks/HRD-099-commons-auth.md`; Wave 3a commits (`dbbea95..0cc6fad`) keep HRD-093 in their messages as executing-time history. r8 captured Wave 3a close-outs: HRD-028 (cherald `/v1/compliance` live), HRD-098 (sherald `/v1/safety_state` live), and the commons_auth/ JWT-verifier scaffold (now HRD-099). 8 new e2e invariants land — E35/E36 auth gate × 2 flavors + E43/E44 cherald compliance + E46/E47 sherald safety_state. E45 + E48 SKIP-with-reason awaiting Wave 3b (pherald Runner + HRD-033 destructive-guard body). Paired §1.1 mutation gate `tests/test_wave3_mutation_meta.sh` (3/3 PASS: M1 strip-verify breaks E35; M5 zero-mem breaks E47; post-flight green). Prior r7: Wave 2 atomic closures HRD-092..097; HRD-012 Claude Code dispatcher live; HRD-011 code complete pending operator creds; HRD-010 commons_storage live wiring + E14 RLS-bypass bug fix; Foundation M1/M2/M3. |
| Issues | see `Issues.md` — r10 removes HRD-028 + HRD-098 from open (atomically Issues→Fixed in r8 commit) and adopts the HRD-099 renumber. |
...
| Fixed | HRD-001..HRD-007, HRD-009, HRD-009b, HRD-010, HRD-012, HRD-013, HRD-014, HRD-017, HRD-028, HRD-080, HRD-092, HRD-093, HRD-094, HRD-095, HRD-096, HRD-097, HRD-098, HRD-099 (and HRD-018 partial — M1 component landed) |
