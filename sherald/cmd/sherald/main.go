// sherald — System Herald per spec V3 §18 + §43 (Wave 2 r1 scaffold).
//
// Single-binary CLI for the System Herald flavor. Stubs every §43
// command targeted at this flavor as a 501-style cli.StubCmd until
// the corresponding HRD implementation lands; the HTTP serve plane
// exposes /v1/safety_state as a 501 stub (→ HRD-098) and the shared
